...
for(item in c("temp","wind")){ # 項目を指定．全部は c("temp","solar","wind")
    for(func in c("mean","sd")){ # 関数を指定．全部は c("mean","var","sd")
...
::: column-margin
関数 `ggpairs()` のオプションを利用して選択することもできる． また属性を指定して色を変えることも可能である．
