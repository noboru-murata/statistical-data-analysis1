...
# Time-stamp: <2026-06-12 15:09:17 mura>
:REVEAL:
...
** 標本共分散
- 観測値 \(X_1,X_2,\dotsc,X_n\) および \(Y_1,Y_2,\dotsc,Y_n\) による推定
- *標本共分散* (sample covariance)
   ...
   #+end_quote
   - ただし\(\bar{X},\bar{Y}\)は
      \(X_1,X_2,\dotsc,X_N\) および \(Y_1,Y_2,\dotsc,Y_N\) の標本平均
...
#+reveal: split
- 分位点の性質
   #+attr_html: :class callout-important
   #+attr_latex: :environment callout-important
   #+begin_quote
